...
from common.training_two_2 import get_batch_metrics, ModelTrainer
...
argument_parser.add_argument("-t", "--train_file", nargs="+", default="/home/boot/wzx/VSR/NLP-GEC/NLP-GEC-EditScorer/data/bea_reranking/gector_variants/bea.train.variants")
...
argument_parser.add_argument("-c", "--checkpoint_dir", default="/home/boot/wzx/VSR/NLP-GEC/NLP-GEC-EditScorer/checkpoints_two_2/")
...
argument_parser.add_argument("--lr", default=3e-7, type=float)
...
argument_parser.add_argument("--note_error_num", default=0, type=int)
...
argument_parser.add_argument("--note_error", default=1, type=float)
