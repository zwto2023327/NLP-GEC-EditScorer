...
from common.training_2 import get_batch_metrics, ModelTrainer
...
argument_parser.add_argument("-c", "--checkpoint_dir", default="/home/boot/wzx/VSR/NLP-GEC/NLP-GEC-EditScorer/checkpoints_2/")
...
argument_parser.add_argument("--lr", default=2e-7, type=float)
