...
argument_parser.add_argument("-c", "--checkpoint_dir", type=str, default="/home/boot/wzx/VSR/NLP-GEC/NLP-GEC-EditScorer/860")
argument_parser.add_argument("-C", "--checkpoint_name", type=str, default="checkpoint_49.pt")
