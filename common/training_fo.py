...
class ModelTrainer:
                                                ...
                                                if self.correctflag > 0:
                                                    if self.testvalidate == 1:
                                                        ...
                                                        if noteindex in self.correctlist and index_list[num] in \
                                                                self.correctlist[noteindex] and ra <= 0.02:
    ...
    def train(self, model, train_data, dev_data=None, total=None, dev_total=None, count_mode="sample", **kwargs):
        ...
        file_path = "/home/boot/wzx/error_epoch_fo.txt"
        if os.path.exists(file_path):
            os.remove(file_path)
        file = open(file_path, "a")
        self.txt_path = "/home/boot/wzx/epoch_txt_fo/"
        self.valtxt_path = "/home/boot/wzx/epoch_val_txt_fo/"
        self.traintxt_path = "/home/boot/wzx/epoch_train_txt_fo/"
