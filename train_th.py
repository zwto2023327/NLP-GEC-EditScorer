...
#argument_parser.add_argument("-L", "--load", default="/home/amax/data/wzx/VSR/NLP-GEC/NLP-GEC-EditScorer/checkpoint1e-04constant.pt")
...
argument_parser.add_argument("--mlp_dropout", default=0.3, type=float)
