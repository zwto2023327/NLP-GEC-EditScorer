...
from common.training_th import get_batch_metrics, ModelTrainer
...
argument_parser.add_argument("-c", "--checkpoint_dir", default="/home/boot/wzx/VSR/NLP-GEC/NLP-GEC-EditScorer/checkpoints_th/")
...
argument_parser.add_argument("--lr", default=1e-6, type=float)
