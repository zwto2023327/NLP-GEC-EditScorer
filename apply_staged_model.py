...
argument_parser.add_argument("-i", "--input_file", default="/home/boot/wzx/VSR/NLP-GEC/data/wi+locness/m2/ABCN.dev.gold.bea19.m2")
argument_parser.add_argument("-r", "--raw", action="store_true")
argument_parser.add_argument("-s", "--stages", default=8, type=int)
argument_parser.add_argument("-v", "--input_variant_file", default="/home/boot/wzx/VSR/NLP-GEC/NLP-GEC-EditScorer/data/bea_reranking/gector_variants/bea.dev.variants")
argument_parser.add_argument("-n", "--max_sents", default=None, type=int)
argument_parser.add_argument("-l", "--language", default=None)
argument_parser.add_argument("-c", "--checkpoint_dir", type=str, default="/home/boot/wzx/VSR/NLP-GEC/NLP-GEC-EditScorer/850")
argument_parser.add_argument("-C", "--checkpoint_name", type=str, default="checkpoint_146.pt")
