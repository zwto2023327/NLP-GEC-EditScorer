...
from common.training_new_2 import get_batch_metrics, ModelTrainer
...
#argument_parser.add_argument("-L", "--load", default="/home/boot/wzx/NLP-GEC-EditScorer/init0.5.pt")
...
argument_parser.add_argument("-c", "--checkpoint_dir", default="/home/boot/wzx/VSR/NLP-GEC/NLP-GEC-EditScorer/checkpoints_new_2/")
